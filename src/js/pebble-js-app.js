...
function renewToken(success) {
	...
	getJson("https://0.4.pebble-notes.appspot.com/auth/refresh?refresh_token="+encodeURIComponent(refresh_token),
...
Pebble.addEventListener("showConfiguration", function(e) {
	...
	var url = "https://0.4.pebble-notes.appspot.com/notes-config.html#"+
